...
def connectDB():
    ...
    if len(cur.fetchall()) == 0:
        ...
        q3 = "CREATE TABLE students (student_id INTEGER NOT NULL UNIQUE, student_name VARCHAR(50), dob VARCHAR(15), course VARCHAR(20), branch VARCHAR(10), address VARCHAR(100), contact VARCHAR(20), img BLOB, g_year INTEGER, PRIMARY KEY('student_id' AUTOINCREMENT));"
